  ...
  (function(require, exports, moduleId) {
    ...
    var Equation = (function() {
      ...
      Equation.prototype['answer'] = function() {
        var operand1=this.instance.sections[0].numbers.children[0].text();
        var operator=this.instance.sections[1].numbers.children[0].text();
        var operand2=this.instance.sections[2].numbers.children[0].text();
        var value;
        switch(operator) {
          case '\u002B':
      ...
      Equation.prototype['guess'] = function() {
        return parseInt(this.instance.sections[4].numbers.children[this.guessindex].text());
      };
      Equation.prototype['onnext'] = function() {
        ++this.guessindex;
        if(this.guessindex === this.sections.sections[4].numbers.children.length) {
          this.guessindex=0;
        }
      ...
      switch(this.operation) {
        case 'minus':
          ...
          guesses.push(guess + '');
          guesses.sort();
          this.instance=numbers.Sections({

(function() {
  ...
  (function(require, exports, moduleId) {
    ...
    var NumberGenerator = (function() {
      ...
      NumberGenerator.prototype['onplay'] = function(event) {
        monads.DOMable({
          tagName:'div'
        }).on('load').attributes({
          'class':'numbers'
        }).text('8 \u00f7  9 \u003d').insert(document.body).place('center');
      };
      NumberGenerator.init = (function () {
        var styles=[{
          selector:'.numbers',
          style:"position:absolute;width:200px;height:200px;white-space:nowrap;color:white;font-family:maagkramp;font-size:200px;font-weight:normal;"
        }];
        monads.Styleable(styles).on("load").onstyle();
      })();
      return function __() {
        var args = Array.prototype.slice.call(arguments);
        __.init = NumberGenerator.init;
    ...
    var Main = (function() {
      function Main() {
        ...
        var ctor = function () {
          ...
          this.wrapper=monads.DOMable({
            ...
            'id':'wrapper'
          }).insert(document.body).add(this.container);
          monads.DOMable({
      ...
      Main.init = (function () {
        var styles=[{
          selector:'body',
          style:"background:rgba(0,0,0,0);margin:0;padding:0;"
        },{
          selector:'#wrapper',
          style:"width:100%;height:100%;background:-webkit-gradient(radial, 48% 30%, 0, 48% 30%, 350, from(rgba(0,0,255,0)), to(rgba(0,0,0,1)));margin:0;padding:0;"
        },{
          selector:'#container',

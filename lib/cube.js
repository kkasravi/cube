  ...
  (function(require, exports, moduleId) {
    ...
    var ProgressBar = (function() {
      ...
      ProgressBar.prototype['start'] = function() {
        ...
        this.div.element().addEventListener('webkitAnimationIteration',this.onend);
      };
      ...
      ProgressBar.init = (function () {
        var styles=[{
          ...
          style:"background-color:orange;width:90%;height:20px;border-radius:10px;"
        },{
    ...
    var Main = (function() {
      ...
      Main.prototype['ontimeout'] = function(event) {
        ...
        this.checker.answer(answer === guess);

  ...
  (function(require, exports, moduleId) {
    ...
    var Shuriken = (function() {
      ...
      Shuriken.init = (function () {
        var styles=[{
          selector:'.shuriken',
          style:"position:absolute;top:100px;left:100px;-webkit-transition:-webkit-transform 2s linear;-webkit-transform-origin-x:127px;-webkit-transform-origin-y:130px;"
        }];
        monads.Styleable(styles).on("load").onstyle();

  ...
  (function(require, exports, moduleId) {
    ...
    var Main = (function() {
      function Main() {
        ...
        var ctor = function () {
          ...
          this.container=monads.DOMable({
            ...
            style:"stop-color:#f1984c;stop-opacity:1",
            offset:"0"
          }).end().stop({
            style:"stop-color:#e77724;stop-opacity:1",
            offset:"1"
          }).end().end().clipPath({
            ...
            style:"stop-color:#f4c592;stop-opacity:1",
            offset:"0"
          }).end().stop({
            style:"stop-color:#f39f58;stop-opacity:1",
            offset:"1"
          }).end().end().clipPath({
            ...
            style:"stop-color:#ed8b38;stop-opacity:1",
            offset:"0"
          }).end().stop({
            style:"stop-color:#f6dac3;stop-opacity:1",
            offset:"1"
          }).end().end().clipPath({
            ...
            style:"stop-color:#f29f59;stop-opacity:1",
            offset:"0"
          }).end().stop({
            style:"stop-color:#ffffff;stop-opacity:1",
            offset:"1"
          ...
          }).end().end().end().svg)).add(monads.DOMable({
            tagName:'div'
          }).on('load').attributes({
            'class':'b'
          }).add(svg.Svg({
            ...
            transform:"matrix(1.25,0,0,-1.25,-589.33125,957.6625)"
          }).g({
            ...
            d:"M 0,0 851,0 851,851 0,851 0,0 z",
            style:"fill:url(#" + this.id + "linearGradient4822);stroke:none",
            id:"path4828"
          }).end().path({
            d:"M 0,0 851,0 851,851 0,851 0,0 z",
            ...
            transform:"matrix(1.25,0,0,-1.25,-104.7875,473.1175)"
          }).g({
            ...
            d:"M 0,0 851,0 851,851 0,851 0,0 z",
            style:"fill:url(#" + this.id + "linearGradient7286);stroke:none",
            id:"path7292"
          }).end().end().g({
            ...
            transform:"matrix(1.25,0,0,-1.25,-589.33,473.1175)"
          }).g({
          ...
          this.container.insert(document.body).on('touchstart').bind(this.ontouchstart).on('touchmove').bind(this.ontouchmove).on('touchend').bind(this.ontouchend);
        }
      ...
      Main.init = (function () {
        var styles=[{
          selector:'body',
          style:"background:#000;color:#e0e0ff;font-size:115%;margin:0;"
        },{
          selector:'#container',
          style:"position: absolute;left: 50%; margin-left:-100px;top: 50%; margin-top:-100px;height: 200px;width: 200px;-webkit-perspective: 800;"
        },{
          selector:'#frame',
          style:"opacity: 0.7;width: 200px;-webkit-transform-style: preserve-3d;-webkit-transform: translateZ(150px);-webkit-transition: all 5s;"
        },{
          selector:'.inner',
          style:"height:200px;width:200px;-webkit-transform: rotateX(90deg);-webkit-transform-style: preserve-3d;-webkit-animation: spin2 20s infinite linear;"
        },{
          selector:'.inner div',
          style:"position: absolute;height:100px;padding-top:100px;width:200px;background-size: 100% 100%;opacity: 1;-webkit-transform: rotateX(-90deg);"
        },{
          selector:'.inner .a',
          style:"-webkit-transform: rotateY(-90deg);left:100px;"
        },{
          selector:'.inner .b',
          style:"-webkit-transform: rotateY(90deg);left:-100px;"
        },{
          selector:'.inner .c',
          style:"-webkit-transform:rotateX(90deg);-webkit-transform:translateZ(-100px);"
        },{
          selector:'.inner .d',

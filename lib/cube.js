  ...
  (function(require, exports, moduleId) {
      ...
      function Title() {
        ...
        var ctor = function () {
          this.title=monads.DOMable({
            ...
            'font-size':'80px',
            '-webkit-transform':'translateX(-150px) translateY(-120px) rotateY(-230deg) rotateX(77deg)',
    ...
    var Selector = (function() {
      function Selector() {
        ...
        var args = Array.prototype.slice.call(arguments);
        var ctor = function () {
          this.choice=monads.DOMable({
            tagName:'div'
          }).on('load').style({
            '-webkit-transform':'translateX(-70px) translateY(170px) rotateY(-70deg)',
            'white-space':'nowrap',
            'height':'60px',
            'width':'60px',
            'color':'#e97825',
      ...
      return function __() {
        var args = Array.prototype.slice.call(arguments);
        __.constructor = Selector;
        return new Selector(args && args.length && args[0]);
      };
    })();
      ...
      function Main() {
        ...
        var ctor = function () {
          ...
          this.frame=monads.DOMable({
            ...
            'class':'inner'
          }).add(this.title).add(this.multiply).add(this.plus).add(this.divide).add(this.minus).add(monads.DOMable({
            tagName:'div'
          }).on('load').attributes({
            'class':'e'
          })).add(monads.DOMable({

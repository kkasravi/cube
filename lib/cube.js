  ...
  (function(require, exports, moduleId) {
    ...
    var Play = (function() {
      function Play() {
        ...
        var ctor = function () {
          this.element=monads.DOMable({
            ...
            'font-family':'Bemio',
            'font-size':'80px',
            '-webkit-transform':'translateX(130px) translateY(-80px) rotateY(-230deg) rotateX(77deg)',
            '-webkit-transition':'-webkit-transform 400ms linear'
          }).textShadow(Play.shadow).text('Math Ninja');
          this.element.delay(this.element.style,[{
            '-webkit-transform':'translateX(130px) translateY(-80px) rotateY(-230deg) rotateX(0deg)'
          }],300);
          return this.element;
        }
        return ctor.apply(this,args) || this;
      ...
      Play.init = (function () {
        var styles=[{
          selector:'@font-face',
          style:'font-family:Bemio;src:url(/cube/lib/Bemio.otf);'
        }];
        monads.Styleable(styles).on("load").onstyle();
      })();
      Play.shadow = ['0 1px 0 #ccc','0 2px 0 #c9c9c9','0 3px 0 #bbb','0 4px 0 #b9b9b9','0 5px 0 #aaa','0 6px 1px rgba(0,0,0,0.1)','0 0 5px rgba(0,0,0,0.1)','0 1px 3px rgba(0,0,0,0.3)','0 3px 5px rgba(0,0,0,0.2)','0 5px 10px rgba(0,0,0,0.25)','0 10px 10px rgba(0,0,0,0.2)','0 20px 20px rgba(0,0,0,0.15)'];
      return function __() {
        var args = Array.prototype.slice.call(arguments);
        __.init = Play.init;
        __.shadow = Play.shadow;
        __.constructor = Play;
    ...
    var Multiply = (function() {
      function Multiply() {
        ...
        var ctor = function () {
          ...
          this.element.on('click').bind(this.onclick);
          return this.element;
        }
        return ctor.apply(this,args) || this;
      }
      Multiply.prototype['onclick'] = function(event) {
    ...
    var Plus = (function() {
      ...
      Plus.prototype['onclick'] = function(event) {
    ...
    var Divide = (function() {
      function Divide() {
        ...
        var ctor = function () {
          ...
          this.element.on('click').bind(this.click);
          return this.element;
        }
        return ctor.apply(this,args) || this;
      }
      Divide.prototype['onclick'] = function(event) {
    ...
    var Minus = (function() {
      ...
      Minus.prototype['onclick'] = function(event) {
      ...
      function Main() {
        ...
        var ctor = function () {
          ...
          this.frame=monads.DOMable({
            ...
            'class':'inner'
          }).add(this.play).add(this.multiply).add(this.plus).add(this.divide).add(this.minus).add(monads.DOMable({
            tagName:'div'
          }).on('load').attributes({
            'class':'e'
          })).add(monads.DOMable({

  ...
  (function(require, exports, moduleId) {
    ...
    var Main = (function() {
      ...
      Main.prototype['onnext'] = function(event) {
        ...
        correct && this.sequence[this.activeSide % 3].board.breakBoard() && this.sparkles.addSparkles(Math.random() * 200 + 100 | 0,x,y,2);
        ...
        this.sequence[this.activeSide % 3].board.repairBoard();

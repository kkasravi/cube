  ...
  (function(require, exports, moduleId) {
          ...
          case 'minus':
            ...
            switch(this.level) {
              ...
              case 2:
                ...
                break;
              default:
                this.operand2=this.operand1 + Math.round(Math.random() * 100);
            }
    ...
    var VerticalNumberStrip = (function() {
      ...
      VerticalNumberStrip.init = (function () {
        var styles=[{
          ...
          style:"width:100px;height:140px;position:absolute;right:0rem;"
        },{
          selector:'.vertical-number-strip-carousel',
          style:"width:100%;height:100%;position:relative;"
        },{
          selector:'.vertical-number-strip-carousel-number',
          style:"width:100px;text-align:center;font-size:3rem;font-family:Albertino;text-shadow:5px 5px 10px rgba(124,116,116,0.5);"
        }];
      ...
      function Checker() {
        ...
        var ctor = function (_properties) {
          ...
          this.total=monads.DOMable({
            ...
            '-webkit-transform':'translateY(0%)',
            '-webkit-transition':'-webkit-transform 400ms linear'
          }).textShadow(Main.shadow).text(this.currentCount + " of " + this.totalCount);
        }
        return ctor.apply(this,args) || this;
      }
    ...
    var Container = (function() {
      ...
      Container.init = (function () {
        var styles=[{
          ...
          selector:'.container',
          style:"position:absolute;top:20%;width:100%;height:20%;-webkit-perspective:1000px;-webkit-transition:-webkit-transform 1s;"
        },{
          selector:'.operators',
          style:"left:40%;text-align:start !important;width:auto !important;"
        },{
          selector:'#cube',
          ...
          selector:'#cube div',
          style:"display:block;position:absolute;width:100%;height:100%;text-align:center;-webkit-backface-visibility:hidden;"
        },{
          selector:'#cube .front',
          style:"-webkit-transform:translateZ(500px);"
        },{
    ...
    var Main = (function() {
      function Main() {
        ...
        var grid = p_vars.grid;
        Object.getOwnPropertyDescriptor(this,'grid') || Object.defineProperty(this,'grid', {get: function(){return grid;},set: function(e){grid=e;}});
        var level = p_vars.level;
        Object.getOwnPropertyDescriptor(this,'level') || Object.defineProperty(this,'level', {get: function(){return level;},set: function(e){level=e;}});
        ...
        var operation = p_vars.operation;
        Object.getOwnPropertyDescriptor(this,'operation') || Object.defineProperty(this,'operation', {get: function(){return operation;},set: function(e){operation=e;}});
        var page = p_vars.page;
        Object.getOwnPropertyDescriptor(this,'page') || Object.defineProperty(this,'page', {get: function(){return page;},set: function(e){page=e;}});
        ...
        var ctor = function () {
          ...
          this.level=1;
          this.title=Title();
          this.title.insert(document.body);
          this.screens.element.insert(document.body);
          this.ninja=cubesvgs.Ninja();
          this.page.add(this.ninja.element).insert(document.body);
          monads.DOMable({
      ...
      Main.prototype['onplay'] = function(event) {
        this.grid=cubes.Cubes();
        this.grid.element.insert(document.body);
        ...
        this.grid.containers.forEach(function (container,i) {
          ...
          monads.DOMable({
            ...
            width:'750px',
            height:'150px'
          }).updateText(this.equations[i].equation + ' ' + this.bestGuess);
        },this);
        this.screens.element.element().style.webkitTransform='translateY(-9em)';
      ...
      Main.prototype['onguess'] = function(event) {
        ...
        monads.DOMable({
          element:this.grid.containers[0].child(2).childNodes.item(1).childNodes.item(1)
        }).on('load').style({
          width:'750px',
          height:'150px'
        }).updateText(this.equations[0].equation + ' ' + this.bestGuess);
        this.onnext();
      };
      Main.prototype['onnext'] = function(event) {
        var answer=this.equations[0].answer;
      ...
      Main.init = (function () {
        var styles=[{
          selector:'@font-face',
          style:'font-family:Albertino;src:url(lib/Albertino_1.0.ttf);'
        },{
          selector:'body',

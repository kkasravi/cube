    ...
    var Shuriken = (function() {
      ...
      Shuriken.init = (function () {
        var styles=[{
          ...
          selector:'.shuriken',
          style:"position:absolute;top:10%;left:5%;-webkit-transform-origin-x:84px;-webkit-transform-origin-y:87px;-webkit-animation:shurikenspin 1500ms linear infinite;"
        }];
        monads.Styleable(styles).on("load").onstyle();

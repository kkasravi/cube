module cubesvgs {
  ...
  export class Ninja {
    constructor() {
      ...
      @sword = @ninja.svg.getElementById('sword');
      @swordblade = @ninja.svg.getElementById('swordblade');
    }
    changeBelt(color) {
        ...
        svg.Svg({width:"180.0",height:"200.0"}).
          defs().
            ...
            clipPath({clipPathUnits:"userSpaceOnUse",id:@id+"clipPath4810"}).
              path({d:"m 760.601,533.69 c 0,-31.182 -25.513,-56.693 -56.695,-56.693 l -170.078,0 c -31.181,0 -56.693,25.511 -56.693,56.693 l 0,170.078 c 0,31.182 25.512,56.694 56.693,56.694 l 170.078,0 c 31.182,0 56.695,-25.512 56.695,-56.694 l 0,-170.078"}).end().
            end().
            ...
            clipPath({clipPathUnits:"userSpaceOnUse",id:@id+"clipPath4854"}).
              path({d:"m 703.906,754.792 -170.077,0 c -28.136,0 -51.024,-22.889 -51.024,-51.022 l 0,-67.67 c 40.388,-11.071 86.752,-17.371 136.062,-17.371 49.309,0 95.672,6.3 136.062,17.371 l 0,67.67 c 0,28.133 -22.889,51.022 -51.023,51.022"}).end().
            end().
            ...
            clipPath({clipPathUnits:"userSpaceOnUse",id:@id+"clipPath4888"}).
              path({d:"m 533.827,482.665 170.076,0 c 14.071,0 26.826,5.723 36.064,14.962 l -242.199,0 c 9.237,-9.239 21.994,-14.962 36.059,-14.962"}).end().
            end().
            ...
            clipPath({clipPathUnits:"userSpaceOnUse",id:@id+"clipPath4912"}).
              path({d:"m 533.827,754.792 170.076,0 c 14.071,0 26.826,-5.723 36.064,-14.961 l -242.199,0 c 9.237,9.238 21.994,14.961 36.059,14.961"}).end().
            end().
          ...
          g({id:'plus',transform:"matrix(0.5,0,0,-0.5,-233.0,408.0)"}).
            g({'clip-path':"url(#"+@id+"clipPath4800)"}).
              path({d:"m 703.906,471.327 -170.078,0 c -34.388,0 -62.363,27.976 -62.363,62.364 l 0,170.077 c 0,34.386 27.975,62.362 62.363,62.362 l 170.078,0 c 34.39,0 62.365,-27.976 62.365,-62.362 l 0,-170.077 c 0,-34.388 -27.975,-62.364 -62.365,-62.364",style:"fill:#ffffff;fill-opacity:1;fill-rule:nonzero;stroke:none"}).end().
            end().
            g({'clip-path':"url(#"+@id+"clipPath4810)"}).
              path({d:"M 0,0 851,0 851,851 0,851 0,0 z",style:"fill:url(#"+@id+"linearGradient4832);stroke:none"}).end().
